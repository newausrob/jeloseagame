 // mkns
   ...
   // Add event listener to the restart button
	...
	let randomFactorDecimal2 = 2 + Math.random() * 3.3;

	if (randomFactor === 0) randomFactor = 2; // Ensure randomFactor is at least 1
	let halfDistance = Math.round(obstaclePosition / randomFactor); // Round to nearest whole number
	...
	console.log(`Random Factor Decimal2: ${randomFactorDecimal2}`);
        ...
        obstacleInterval = setInterval(() => {
            if (obstaclePosition < -20) {
                ...
                if (obstaclePosition === halfDistance) {
                    if (!isSlowed) {
			...
			console.log(`ObstacleSpeed: ${obstacleSpeed}`);
                        ...
                        obstacleSpeed *= randomFactorDecimal;
                        isSlowed = false;
			console.log(`ObstacleSpeed Sped: ${obstacleSpeed}`);
                    }
                }
